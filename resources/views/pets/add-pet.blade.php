                ...
                <form class="row g-3" action="{{ route('add-pet.store') }}" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="text-center d-flex flex-column align-items-center" id="profile-img">
                        ...
                        <div class="file btn btn-primary position-relative overflow-hidden" id="upload-img">
                            ...
                            <input type="file" name="pet_image" id="image-input" accept="image/x-png,image/gif,image/jpeg" />
                        </div>
                    </div>
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        ...
                        @foreach($gender as $g)
                            <div class="form-check form-check-inline">
                                <input type="radio" class="form-check-input" id="{{$g}}" name="gender" value="{{$g}}" {{(old('gender') == $g) ? 'checked' : ''}}>
                    ...
                    <div class="col-md-12">
                        ...
                        @foreach($characteristics as $c)
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="{{$c}}" name="characteristic[]" value="{{$c}}" {{ (is_array(old('characteristic')) && in_array($c, old('characteristic'))) ? 'checked':''}}>
