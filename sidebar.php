<nav id="sidebar">
    <ul class="navbar-nav">
        <li title="Profile" class="nav-item ps-2">
            <a href="./profile.php" class="nav-link active text-white" aria-current="page">
        ...
        <li title="Users" class="nav-item ps-2">
            <a href="./users.php" class="nav-link active text-white" aria-current="page">
                <i class="fa-solid fa-users pe-3"></i>
                <span class="sidebar-item pe-3">Users<span>
            </a>
        </li>
        <li title="Pets" class="nav-item ps-2">
            <a href="./pets.php" class="nav-link active text-white" aria-current="page">
